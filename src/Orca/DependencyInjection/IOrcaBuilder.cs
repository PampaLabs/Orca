...
namespace Orca
{
    ...
    public interface IOrcaBuilder
    {
        ...
        /// <summary>
        /// Allow to register a new <see cref="IPropertyBag"/> to be used on Orca DSL policies.
        /// </summary>
        /// <typeparam name="TPropertyBag">The <see cref="IPropertyBag"/> to be used.</typeparam>
